...
extern json_spirit::Value exportblackcoinkeys(const json_spirit::Array& params, bool fHelp); // in rpcdump.cpp
...
extern json_spirit::Value distribute(const json_spirit::Array& params, bool fHelp);
